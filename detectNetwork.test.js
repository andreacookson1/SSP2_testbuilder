...
describe('Discover', function() {
 ...
 it('has a prefix of 6011 and a length of 16', function() {
  detectNetwork('6011000990139424').should.equal('Discover');
 });

 it('has a prefix of 6011 and a length of 19', function() {
  detectNetwork('6011000000000000004').should.equal('Discover');
 });

 it('has a prefix of 65 and a length of 16', function() {
  detectNetwork('6511000990139424').should.equal('Discover');
 });

 it('has a prefix of 65 and a length of 19', function() {
  detectNetwork('6511000000000000004').should.equal('Discover');
 });
 ...
 for (var prefix = 644; prefix <= 649; prefix++) {
  (function(prefix) {
   it('has a prefix of ' + prefix + ' and a length of 16', function() {
    detectNetwork(prefix + '1000990139424').should.equal('Discover');
   });
   it('has a prefix of ' + prefix + ' and a length of 19', function() {
    detectNetwork(prefix + '1000000000000004').should.equal('Discover');
   });
  })(prefix)
 }
});
...
var should = chai.should();
 var actual = '6250946000000016';

 for (var cardLength = 16; cardLength <= 19; cardLength++) {
  (function(cardLength, actual) {
   it('has a prefix of 62 and a length of ' + cardLength, function() {
